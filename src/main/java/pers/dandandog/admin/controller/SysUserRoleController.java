...
@Api(value = "系统用户角色关系表Api", tags = {"SysUserRoleController"})
public class SysUserRoleController extends ApiController {
    ...
    public ApiResponse<QueryResult> selectAll(Page<SysUserRole> page, SysUserRole sysUserRole) {
        page = this.sysUserRoleService.page(page, new QueryWrapper<>(sysUserRole));
